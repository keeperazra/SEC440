...
$Uri = 'https://ec2-54-160-68-13.compute-1.amazonaws.com/nowire/wgcheck.php'
$Uri_Check_Auth = 'https://ec2-54-160-68-13.compute-1.amazonaws.com/nowire/auth_check.php'
...
if (Test-Path -Path "C:\Program Files\WireGuard\wg.exe") {
...
# Overwrite CertificatePolicy to accept all certificates (allows self-signed certificates on VPN server but may have undesirable security results)
add-type @"
    using System.Net;
